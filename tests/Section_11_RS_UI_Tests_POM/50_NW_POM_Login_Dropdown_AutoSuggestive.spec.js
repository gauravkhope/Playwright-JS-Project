...
test('Section_11_RS_UI_Tests - RahulShettyAcademy Client App Login - POM_Login_Dropdown_AutoSuggestive', async ({page} )=> {
    ...
    const data_login_username = "grkhope.gk@gmail.com";
    const data_login_password = "Gaurav31";
    ...
    console.log('checkoutPage.get_TxtBox_Email().textContent(): '+ await checkoutPage.get_TxtBox_Email().textContent());
    ...
    await checkoutPage.searchCountryAndSelect('i',country_ToSearch);
