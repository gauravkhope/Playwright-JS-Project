...
test('Section_09_RS_UI_API_Tests - RahulShettyAcademy Client App Login - Intercept_API_Request_Message_YouAreNotAuthorized', async ({page})=> {
    ...
    await page.locator('#userEmail').fill('grkhope.gk@gmail.com');
    await page.locator('#userPassword').fill('Gaurav31');
    waitForSomeTime(2);
    ...
    await page.route(
        // Request URL
        // 6266ccd2e26b7e1a10e8d1c5 -> ID of the product from grkhope.gk@gmail.com account
